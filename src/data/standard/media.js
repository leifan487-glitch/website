...
export const standardDerivedMedia = [
  ...
  },
  {
    ...
    descriptionZh: "整机展示、桌面取放、织物处理、洗衣协作、末端工具与工业巡检的连续实录。",
    descriptionEn: "A rapid field montage spanning the full robot, tabletop pick and place, textile handling, laundry, tool use, and industrial inspection.",
    category: "MULTI-TASK",
    ...
    privacyRisk: "MEDIUM",
    audioRemoved: true,
    poster: "/assets/videos/standard/applications-montage-v2/poster.webp",
    video: "/assets/videos/standard/applications-montage-v2/video.mp4",
    duration: 12.3,
    durationLabel: "00:12",
    width: 1920,
    height: 1080,
    ...
    publicApproved: true,
    derivedCompilation: true,
    sourceMediaIds: ["SV002", "SV005", "SV032", "SV036", "SV044", "SV050"],
    derivedFrom: "Six owner-supplied Standard source masters excluded from the homepage Real World reel",
    clipRanges: [
      { sourceMediaId: "SV002", start: 0.4, end: 2.4, duration: 2 },
      { sourceMediaId: "SV005", start: 3.2, end: 5.3, duration: 2.1 },
      { sourceMediaId: "SV032", start: 40, end: 42.1, duration: 2.1 },
      { sourceMediaId: "SV036", start: 0.8, end: 2.8, duration: 2 },
      { sourceMediaId: "SV044", start: 3, end: 5, duration: 2 },
      { sourceMediaId: "SV050", start: 0.2, end: 2.3, duration: 2.1 },
    ],
    generatedAt: "2026-09-12",
    derivativeType: "APPLICATIONS_MONTAGE_V2",
    notes: "Task 021 six-scene Applications montage; direct action cuts approximately every two seconds, no homepage reel sources, no speed changes, overlays, audio, or runtime source rotation. Versioned asset URL prevents the retired single-scene / first montage cache from persisting in browsers.",
  },
];
