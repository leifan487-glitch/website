...
import { reopenedOwnerFeedback } from './owner-feedback-scope.mjs';
...
export const reopened0188bf = new Set(['src/data/home.js', 'src/home.css', 'src/pages/HomePage.jsx', ...reopenedOwnerFeedback]);
// Owner's final homepage card reopens only headings/forms and contact IA (not email logic).
export const reopenedHomeFinal = new Set(['src/pages/HomePage.jsx', 'src/components/HomeProductStory.jsx', 'src/components/HomeSections.jsx', 'src/components/Navbar.jsx', 'src/App.jsx', 'src/data/siteMetadata.js', 'worker/index.js', ...reopenedOwnerFeedback]);
